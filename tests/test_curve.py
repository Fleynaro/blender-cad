...
class TestCurveGeometry(BaseCADTest):
    ...
    def test_single_line(self):
        ...
        self.assertPart(
            result.part,
            "a22f6147434fe40d144958d5de0a287c9c6a58b66489cf175adf950b17d37acb",
            "test_single_line",
        )
    ...
    def test_polyline_open(self):
        ...
        self.assertPart(
            result.part,
            "cecc5d71860623a80b41a28ed7467c33b4cb355f257d644dd8910758ebb50666",
            "test_polyline_open",
        )
    ...
    def test_nurbs_spline_closed(self):
        ...
        self.assertPart(
            result.part,
            "f19e56713e5a081a4e1fa9ca10293a3083a3ad1e2796ceff15090b852608367c",
            "test_nurbs_spline_closed",
        )
    ...
    def test_at_evaluation_complex_spline(self):
        ...
        self.assertPart(
            result.part,
            "1d89a125d9098f6fb87ae7dda109045a27c0bdef9db2719a9a87d6df12d38c08",
            "test_at_evaluation_complex_spline",
        )
    ...
    def test_multi_island_evaluation(self):
        ...
        self.assertPart(
            result.part,
            "88162da725e05c2842d0b4c8d80d1bb65b39f8ed01e3ba96ea53848b6fafc1f0",
            "test_multi_island_evaluation",
        )
    ...
    def test_bezier_continuity(self):
        ...
        with BuildPart() as result:
            with BuildCurve() as bc:
                BezierCurve(
                    start=(0, 0, 0), handle1=(0, 5, 0), handle2=(5, 5, 0), end=(5, 0, 0)
                )
        ...
        self.assertPart(
            result.part,
            "dab2f9bf5e794222af2bd2928eed5161e7eced09293c92db24b85968c4fc0aa8",
            "test_bezier_continuity",
        )
    ...
    def test_automatic_vertex_merging(self):
        ...
        with BuildPart() as result:
            ...
            self.assertEqual(
                num_splines, 1, "Lines failed to merge into a single spline!"
            )
            self.assertEqual(
                num_points, 3, "Merged spline should have 3 points, not 4!"
            )
        ...
        self.assertPart(
            result.part,
            "e1080b459dd928b21eddf35f84de36f5fbf0549a6e397272a843f13ec72847f4",
            "test_automatic_vertex_merging",
        )
    ...
    def test_curve_locations_distribution(self):
        ...
        self.assertPart(
            result.part,
            "a160e3b9135d96c77eca0637460b106782a47a9948f9cf9dd1ff2a055e1f0046",
            "test_curve_locations_distribution",
        )
    ...
    def test_pipe_run_simulation(self):
        ...
        self.assertPart(
            result.part,
            "439f1cc2f58c80bfc71f12082a6d20ad63e69e466c3f24a50c970e113fce189f",
            "test_pipe_run_simulation",
        )
    ...
    def test_sine_wave_spline(self):
        ...
        self.assertPart(
            result.part,
            "ef07a0938f3067bd27cb4885ca95a022b8efbf844747c318ae7c6d8fa1bb07fc",
            "test_sine_wave_spline",
        )
    ...
    def test_spiral_3d_spline(self):
        ...
        self.assertPart(
            result.part,
            "731ae681b333425b425f51f7e7cbe646a1b681bcb500cfcc5f1c6f2d9b48f985",
            "test_spiral_3d_spline",
        )
    ...
    def test_tangent_arc(self):
        ...
        self.assertPart(
            result.part,
            "9b695d09689b3b2b2026a11f160886d8cba9823f612f9d657ecf676c4405aeaa",
            "test_tangent_arc",
        )
    ...
    def test_radius_arc(self):
        ...
        self.assertPart(
            result.part,
            "c851f1d69fe7585226160a5ad14b6abf460c2eab4f28b2b9b7b8c58f3ec8ec99",
            "test_radius_arc",
        )
    ...
    def test_center_arc(self):
        ...
        self.assertPart(
            result.part,
            "7b8dc96cea3d8f1fa26e44df945a6ffdd8bc97f284ff3635e1a7ca64f81fad73",
            "test_center_arc",
        )
    ...
    def test_jiggle_line(self):
        ...
        self.assertPart(
            result.part,
            "8506a9945fe52c73e8567381db7127e5ff9937d1c3825dc21561a7d4b1653dae",
            "test_jiggle_line",
        )
        ...
        with BuildPart() as result:
            ...
            c_built = curve(
                ...
                curve(
                    ...
                    curve.step(
                        10, angle=120
                    ),  # Creates a 60-degree internal angle for the triangle
                    # Deepest sub-curve block: Shift tracking position and trace a vertical path
                    curve(
                        curve.move_to_Y(),
                        curve.step(
                            5, rot=Rot(Y=90)
                        ),  # Rotates the path direction vertically via Y-axis rotation
    ...
    def test_bvh_curve_construction_and_directional_normal_assertions(self):
        ...
        self.assertPart(
            result.part,
            "d975fbe97987f44708eac58df3279ba74c55bbd50f089d1a96d94a4d0eb6664c",
    ...
    def test_curve_builder_tag_system_and_sub_curve_isolation(self):
        ...
        with BuildPart() as result:
            ...
            sub_curve_c_body_only = c.tagged("C").untagged(
                Curve.TAG_POINT_FIRST, Curve.TAG_POINT_LAST
            )
