...
class TestScopingAndContext(BaseCADTest):
    ...
    def test_explicit_add_operation(self):
        ...
        self.assertPart(
            result.part,
            "a00e6d1208e3c70c0540e2ece193f09fa0f486324a8e4822fd2ee695bbcd193f",
            "test_explicit_add_operation",
        )
    ...
    def test_nested_builders(self):
        ...
        self.assertPart(
            result.part,
            "e1db0179bdc54097dda347ba015900dc8d835724b6f953362db7c43a90d2a400",
            "test_nested_builders",
        )
