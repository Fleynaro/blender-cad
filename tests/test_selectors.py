...
class TestGeometryCheckpoints(BaseCADTest):
    def test_stacked_boxes_no_overlap(self):
        ...
        self.assertPart(result.part, "8bd570ed24140f2a9202af98d0cfa66025b10177fda629460f82099af2d80bee", "test_stacked_boxes_no_overlap", use_materials=True)
    ...
    def test_overlapping_boxes_union(self):
        ...
        self.assertPart(result.part, "d4720a970bc079a3620067bee14debcb776e2ad3d0eec85c227b0a1dc127383e", "test_overlapping_boxes_union", use_materials=True)
    ...
    def test_boolean_subtraction_cutout(self):
        ...
        self.assertPart(result.part, "5d6d9c24dbd8df32dbb1fd6cf4a7530cdf197e7bbf8c8b0c6117a20406d9eb28", "test_boolean_subtraction_cutout", use_materials=True)
    ...
    def test_separate_planes(self):
        ...
        self.assertPart(result.part, "f23fbd7b177866ffae3367572496adc0b499cde217271598774a530361c72b8f", "test_separate_planes", use_materials=True)
    ...
    def test_extrude_wire_selection(self):
        ...
        self.assertPart(result.part, "923f11f9f4e28d1317f73fcc03b47f8eb17cc66765b4af1cae7dad82a35ea1f8", "test_extrude_wire_selection", use_materials=True)
    ...
    def test_manual_checkpoint_persistence(self):
        ...
        self.assertPart(result.part, "c6ad3496eee4c969f54c223ceeaac345b87d1becf4b2fa8af4b1bc004b947935", "test_manual_checkpoint_persistence", use_materials=True)
    ...
    def test_bevel_selection(self):
        ...
        self.assertPart(result.part, "08654681fe8ee37193b6b304953833aec60d36dac5cdb2d6f6292c42f6fea35e", "test_bevel_selection", use_materials=True)
...
class TestTags(BaseCADTest):
    ...
    def test_markup_layout_automatic_border_and_background_tagging(self):
        ...
        with BuildPart() as result:
            ...
            transform(faces().tagged(Part.TAG_ML_BACKGROUND), op=Origin(0.5) * Scale(XY=0.5))
