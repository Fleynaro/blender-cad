...
class TestMaterialsAndVisuals(BaseCADTest):
    ...
    def test_simple_pbr(self):
        ...
        self.assertMaterial(
            gold,
            "724b405cf27749911630d1c5d55a87ecf17c85644c435779665f6f6c81ee54fe",
            "test_simple_pbr",
        )
    ...
    def test_layer_addition(self):
        ...
        self.assertMaterial(
            my_mat,
            "7138e2c8266040dbfbf0c74c1a18de294c617e5544e7b5d8fc72785170780302",
            "test_layer_addition",
        )
    ...
    def test_factor_scaling(self):
        ...
        self.assertMaterial(
            my_mat,
            "3918e19baf95b6caf000b50bd4f38ecc67003de0c99cf575340ac7a7617722d0",
            "test_factor_scaling",
        )
    ...
    def test_variable_external(self):
        ...
        self.assertMaterial(
            my_mat,
            "85c68d35ee9f53e0e7d89b88e65f56bf7ab797bdac3139f879140e2fa0a0c575",
            "test_variable_external",
        )
    ...
    def test_variable_internal(self):
        ...
        self.assertMaterial(
            my_mat,
            "2f0c96329812c688f38b8346fcb792e5025781d11865ec11fdf09f5d22dcfbbc",
            "test_variable_internal",
        )
    ...
    def test_base_color_blending(self):
        ...
        class RedOverlay(mat.Layer):
            def build(self, ctx):
                ...
                ctx.channels.base_color = ctx.blend(
                    ctx.channels.base_color, (1.0, 0.0, 0.0, 1.0), factor=0.5
                )
        ...
        self.assertMaterial(
            my_mat,
            "ce4c059f474a58e9b5acaba3cfdc261957badc2f2efc24c5fe965a8902a32177",
            "test_base_color_blending",
        )
    ...
    def test_meta_naming(self):
        ...
        self.assertMaterial(
            my_mat,
            "5e195a89a97e7d747024c07d48b1f878d8b916cffe217ea661bd0b034dc019d3",
            "test_meta_naming",
        )
    ...
    def test_nested_composition(self):
        ...
        self.assertMaterial(
            my_mat,
            "4a96c147e5fb9b419a4b2fc7b0940656dd9f8c477b18f0547595fe16036b1915",
    ...
    def test_mixed_types_in_channel(self):
        ...
        class MixedMetallicMat(mat.Layer):
            def build(self, ctx) -> None:
                ...
                ctx.channels.metallic = ctx.blend(
                    ctx.channels.metallic, 1.0, factor=0.5
                )
                ...
                ctx.channels.metallic = ctx.blend(
                    ctx.channels.metallic, dirt_tex, factor=0.3
                )
        ...
        self.assertMaterial(
            my_mat,
            "3d57b33ff689fa29db320b79e9a15b0bba75326fab24b507a4fdbd706f85d05a",
            "test_mixed_types_in_channel",
        )
    ...
    def test_pbrmat_subtraction(self):
        ...
        sub_layer = mat.PBR(metallic=0.7, mode=BlendMode.SUBTRACT)
        ...
        self.assertMaterial(
            my_mat,
            "9e7efbe9ad3d3a52e02f07a54168ff0dcbf6acb99e71def15271d2d2992602b4",
            "test_pbrmat_subtraction",
        )
    ...
    def test_pbrmat_multiply_scalar_by_rgba(self):
        ...
        mult_layer = mat.PBR(metallic=(0.5, 0.6, 0.7, 0.8), mode=BlendMode.MULTIPLY)
        ...
        self.assertMaterial(
            my_mat,
            "a051a3cbabd3823360b5a2cb71490dd07a94beaacd21cfe93d8ebb54ec85629c",
            "test_pbrmat_multiply_scalar_by_rgba",
        )
    ...
    def test_material_assignment_by_z_groups(self):
        ...
        self.assertPart(
            result.part,
            "2f26b7bbb20474799ea9fac4ab8028a2feca651c34572304a7ccb559c204d8e4",
            "test_material_assignment_by_z_groups",
            use_materials=True,
        )
    ...
    def test_nested_material_logic_and_overrides(self):
        ...
        self.assertPart(
            result.part,
            "0b3b156b62392ecb28c63530f4745a2b07b1bd761952571524fd0448659d7062",
            "test_nested_material_logic_and_overrides",
            use_materials=True,
        )
    ...
    def test_procedural_dirt(self):
        ...
        self.assertMaterial(
            my_mat,
            "fb53f345ed86a5fc840c48f13ede7dbde25a0e6ced213158250a79325bacc327",
            "test_procedural_dirt",
        )
    ...
    def test_heavy_rust_on_metal(self):
        ...
        self.assertMaterial(
            my_mat,
            "d60916d48f16120dae365c08670992ffb289259228deda37c6763d5aa39e5861",
            "test_heavy_rust_on_metal",
        )
    ...
    def test_stacked_procedurals(self):
        ...
        self.assertMaterial(
            my_mat,
            "a8ed63932bf870c7673456354719e10b3ae481716f01616ed5ffa7b4c386e82f",
            "test_stacked_procedurals",
        )
    ...
    def test_clear_glass(self):
        ...
        self.assertMaterial(
            glass,
            "1abacd61f396abc5ff9b91c4ec01c65eb482faf38162696522d1a108181f81d8",
            "test_clear_glass",
        )
    ...
    def test_frosted_glass_with_dust(self):
        ...
        base_glass = mat.Glass(color=(0.7, 0.9, 1.0, 1.0), roughness=0.25, ior=1.45)
        ...
        self.assertMaterial(
            my_mat,
            "37a62a06fe5dea86765b9da7997867b885f52924857688fc41aa44e1fb5d61cc",
            "test_frosted_glass_with_dust",
        )
    ...
    def test_laser_grid_cube(self):
        ...
        laser_material = mat.LaserGrid(
            color=(1.0, 0.0, 0.0, 1.0), scale=2.0, thickness=0.05, glow_intensity=30.0
        )
