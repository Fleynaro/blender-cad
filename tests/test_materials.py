...
class TestMaterialsAndVisuals(BaseCADTest):
    ...
    def test_material_assignment_by_z_groups(self):
        ...
        self.assertPart(result.part, "2f26b7bbb20474799ea9fac4ab8028a2feca651c34572304a7ccb559c204d8e4", "test_material_assignment_by_z_groups", use_materials=True)
    ...
    def test_nested_material_logic_and_overrides(self):
        ...
        self.assertPart(result.part, "0b3b156b62392ecb28c63530f4745a2b07b1bd761952571524fd0448659d7062", "test_nested_material_logic_and_overrides", use_materials=True)
