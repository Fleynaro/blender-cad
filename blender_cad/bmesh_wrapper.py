...
class BMVertWrapper:
    ...
    def link_edges(self):
        ...
        """
        return sorted(
            [BMEdgeWrapper(e) for e in self.native.link_edges],
            key=lambda e: tuple(e.center),
        )
    ...
    def link_faces(self):
        ...
        """
        return sorted(
            [BMFaceWrapper(f) for f in self.native.link_faces],
            key=lambda f: tuple(f.center),
        )
...
class BMEdgeWrapper:
    ...
    def verts(self):
        ...
        """
        return sorted(
            [BMVertWrapper(v) for v in self.native.verts], key=lambda v: tuple(v.co)
        )
...
class BMFaceWrapper:
    ...
    def edges(self):
        ...
        """
        return sorted(
            [BMEdgeWrapper(e) for e in self.native.edges], key=lambda e: tuple(e.center)
        )
